          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold text-yellow-400">Frequently Asked Questions</span>
              </div>
            </div>
          </div>
        </nav>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-6">
              <Link href="/how-it-works" className="group">
                <Card className="bg-neutral-900/50 border border-yellow-600/20 p-6 hover:border-yellow-400/40 transition-all">
                  <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-yellow-400 transition-colors">
                    How It Works
                  </h3>
                  <p className="text-gray-400 text-sm">
                    Learn about our proven 3-step system for achieving your goals.
                  </p>
                </Card>
              </Link>
              ...
              <Link href="/features" className="group">
                <Card className="bg-neutral-900/50 border border-yellow-600/20 p-6 hover:border-yellow-400/40 transition-all">
                  ...
                  <p className="text-gray-400 text-sm">
                    Discover all the tools and features included in your system.
                  </p>
                </Card>
              </Link>
